...
//       <div className="col fs-3" style={{ textAlign: "left" }}>
//         <img src="images/hotel_logo4.png" alt="호텔 로고" />
//         <Link to="/" style={{ color: "black", fontWeight: "bold", marginLeft: "8px", textDecoration: "none" }}>
//           HOTEL Reservation System
//         </Link>
//       </div>
...
//         <Link to="/cart" style={{ textDecoration: "none", color: "black" }}>장바구니</Link>{" | "}
//         <Link to="/orders" style={{ textDecoration: "none", color: "black" }}>예약조회</Link>{" | "}
//         <Link to="/customer-care" style={{ textDecoration: "none", color: "black" }}>고객센터</Link>
//       </div>
//     </div>
//   </div>
// );
